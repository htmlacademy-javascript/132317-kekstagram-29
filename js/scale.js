...
//функция для кнопки уменьшения размера изображения
...
//функция для кнопки увеличения размера изображения
...
//функция для сброса значения масштаба
const resetScale = () => scaleValue(DEFAUL_SCALE);
